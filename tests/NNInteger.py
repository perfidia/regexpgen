...
class Test(unittest.TestCase):
	...
	def __testForNegativeMinMax(self):
		self.assertRaises(ValueError, regexpgen.nnint,"%0d", -100, 100)
		self.assertRaises(ValueError, regexpgen.nnint,"%0d", 100, -100)

		self.assertRaises(ValueError, regexpgen.nnint,"%0d", -100, None)
		self.assertRaises(ValueError, regexpgen.nnint,"%0d", None, -100)

		self.assertRaises(ValueError, regexpgen.nnint,"%d", -100, 100)
		self.assertRaises(ValueError, regexpgen.nnint,"%d", 100, -100)

		self.assertRaises(ValueError, regexpgen.nnint,"%d", -100, None)
		self.assertRaises(ValueError, regexpgen.nnint,"%d", None, -100)

		self.assertRaises(ValueError, regexpgen.nnint,"%02d", -100, 100)
		self.assertRaises(ValueError, regexpgen.nnint,"%02d", 100, -100)

		self.assertRaises(ValueError, regexpgen.nnint,"%02d", -100, None)
